...
class _$UserDocumentReference
  ...
  Future<void> update({
    ...
    assert(
      verified == _sentinel || verifiedFieldValue == null,
      "Cannot specify both verified and verifiedFieldValue",
    );
    final json = {
      ...
      if (verified != _sentinel)
        _$$_UserFieldMap['verified']!: verified as bool,
      if (verifiedFieldValue != null)
        _$$_UserFieldMap['verified']!: verifiedFieldValue,
    };
...
class _$UserQuery extends QueryReference<User, UserQuerySnapshot>
  ...
  UserQuery orderByVerified({
    ...
    final query = $referenceWithoutCursor.orderBy(_$$_UserFieldMap['verified']!,
        descending: descending);
    var queryCursor = $queryCursor;
